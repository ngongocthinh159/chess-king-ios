...
struct MyTextStyleModifier: ViewModifier {
    @Environment(ModelData.self) var modelData
        
    func body(content: Content) -> some View {
        content
            .font(.custom(modelData.appConfig.appFontBlack, size: modelData.appConfig.isIPhone ? 18 : 24))
...
extension View {
    ...
    func myTextStyle() -> some View {
        self.modifier(MyTextStyleModifier())
    }
}
